...
void DOP_CreatePDOTable(void)
{
	...
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_LOOP_CNT],		     				DOP_UINT32,		    1);

	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_FRONT_MEDIAL_X],  				    DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_FRONT_MEDIAL_Y],  					DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_FRONT_MEDIAL_Z],  					DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_FRONT_LATERAL_X],  					DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_FRONT_LATERAL_Y],  					DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_FRONT_LATERAL_Z],  					DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_BACK_X],  							DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_BACK_Y],  							DOP_FLOAT32,		1);
	AssemblePDO( (PDOInfo_t*)PDOTable [TASK_ID_EXTDEV] [PDO_ID_EXTDEV_BACK_Z],  							DOP_FLOAT32,		1);
